...
def get_all(symbol):
    ...
    """
    values = _request(symbol, 'ydb2r1b3qpoc1d1cd2c6t1k2p2c8m5c3m6gm7hm8k1m3lm4l1t8w1g1w4g3p1g4mg5m2g6kvjj1j5j3k4f6j6nk5n4ws1xj2va5b6k3t7a2t615l2el3e7v1e8v7e9s6b4j4p5p6rr2r5r6r7s7').split(',')
    return dict(
